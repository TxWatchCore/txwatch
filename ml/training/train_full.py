...
plt.grid(True)
plt.tight_layout()
plt.savefig("../models/precision_recall_curve_v2.png")
print("Saved precision/recall curve to ml/models/precision_recall_curve_v2.png")
...
with open("../models/txwatch_v2.onnx", "wb") as f:
    f.write(onnx_model.SerializeToString())

print("Model saved to ml/models/txwatch_v2.onnx")

with open("../models/encoders_v2.pkl", "wb") as f:
    pickle.dump(encoders, f)

print("Encoders saved to ml/models/encoders_v2.pkl")
...
import pickle
with open("../models/txwatch_v2_lgbm.pkl", "wb") as f:
    pickle.dump(model, f)
print("LightGBM model saved to ml/models/txwatch_v2_lgbm.pkl")
